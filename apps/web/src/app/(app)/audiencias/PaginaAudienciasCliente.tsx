...
const DEMO_AUDIENCIAS: Audiencia[] = [
  { id: 'a1', nombre: 'Compradores últimos 180 días', tipo: 'custom', tamaño: 45_000, descripcion: 'Personas que realizaron una compra en los últimos 180 días vía Pixel.', campañasActivas: 3, actualizacion: 'Hace 2 horas' },
  { id: 'a2', nombre: 'Visitantes del sitio 30 días', tipo: 'custom', tamaño: 128_000, descripcion: 'Todos los visitantes del sitio web en los últimos 30 días.', campañasActivas: 2, actualizacion: 'Hace 1 hora' },
  { id: 'a3', nombre: 'Lookalike Compradores 1%', tipo: 'lookalike', tamaño: 1_200_000, descripcion: 'Similar al 1% superior de compradores. Alta intención de compra.', campañasActivas: 2, actualizacion: 'Hace 3 días' },
  { id: 'a4', nombre: 'Lookalike Visitantes 2%', tipo: 'lookalike', tamaño: 2_400_000, descripcion: 'Similar al 2% de visitantes del sitio. Audiencia de prospección amplia.', campañasActivas: 1, actualizacion: 'Hace 3 días' },
  { id: 'a5', nombre: 'Intereses Fitness & Wellness', tipo: 'saved', tamaño: 3_800_000, descripcion: 'Personas interesadas en fitness, bienestar y vida saludable. 25-45 años.', campañasActivas: 1, actualizacion: 'Hace 5 días' },
  { id: 'a6', nombre: 'Advantage+ Shopping', tipo: 'advantage', tamaño: 0, descripcion: 'Audiencia gestionada automáticamente por Meta para optimizar conversiones.', campañasActivas: 1, actualizacion: 'Actualización continua' },
  { id: 'a7', nombre: 'Carrito abandonado 7 días', tipo: 'custom', tamaño: 8_200, descripcion: 'Personas que agregaron al carrito pero no completaron la compra (7 días).', campañasActivas: 1, actualizacion: 'Hace 30 min' },
  { id: 'a8', nombre: 'Seguidores de Instagram', tipo: 'custom', tamaño: 22_500, descripcion: 'Personas que siguen la cuenta de Instagram del negocio.', campañasActivas: 0, actualizacion: 'Hace 1 día' },
]
              ...
              {audienciasFiltradas.map(a => {
                ...
                return (
                  <tr key={a.id} className="hover:bg-background/50 transition-colors">
                    ...
                    <td className="px-5 py-4 text-right">
                      <span className={cn('text-sm font-medium', a.campañasActivas > 0 ? 'text-success' : 'text-muted-foreground')}>
                        {a.campañasActivas}
                      </span>
                    </td>
